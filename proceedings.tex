...
\section{Method}
This section describes the scientific methodology used to answer the research question. The method includes the literature review presented in the background as well analysing and conducting think-alouds, heuristic evaluation and time logs.

In order to understand the user needs, a literature review has been done as well as a and an analysis of think-alouds conducted by onco-psychologists with two clinicians and one patient. 

To discover major usability flaws a heuristic evaluation has been done. The problems found have been ranked according to their severity, prevalence and ease to solve.
...
Redundancy in buttons.
Buttons and interactions not working.
Layout, layout on smaller screens/responsive design.

\subsection{Think-alouds}
\subsubsection{Positive aspects of the usability}
\subsubsection{Usability aspects to improve}
...
\section{Conclusion}
conclude
The outcome has given criterias to improve the e-learning website.
